...
async def start(bot, message):
  await message.reply_photo("https://telegra.ph/%C4%B0nek-10-01.jpg",caption=START,reply_markup=keyboard)

@Client.on_message(filters.command("help"))
async def help(bot, message):
  await message.reply_photo("https://telegra.ph/%C4%B0nek-10-01.jpg",caption=HELP) 
